...
Model::addSqlQuery('REPONSE_CREATE',
	'INSERT INTO '.Reponse::$table_name.' ('.Reponse::$colId.', '.Reponse::$colIdQuestion.', '.Reponse::$colIdQuestionnaire.', '.Reponse::$colEstJuste.', '.Reponse::$colColonne.', '.Reponse::$colContenu.') VALUES (NULL, :id_question, :idQuestionnaire, :estJuste, :colonne, :contenu)');
