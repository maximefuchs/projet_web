  ...
  <div class="QCM">
    <div class="form-row">
      ...
      <div class="form-check col-sm-2">
        ...
        <br>
        <input type="checkbox" class="form-check-input" id="inputEstJuste" name="EstJuste1" required>
      </div>
  ...
  <div class="QCU" style="display:none;">
    <div class="form-row">
      ...
      <div class="form-check col-sm-2">
        <label for="inputEstJuste">Est Juste</label>
        <br>
        <input type="radio" class="form-check-input" id="inputEstJuste" name="EstJuste" required>
      </div>
      <button type="button" class="close">&times;</button>
    </div>
  </div>
