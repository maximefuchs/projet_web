...
<div class="container">
	...
	<h4 style="margin-top: 30px;"><a href="#" class="bienv-link" onclick="openNav();">Connectez-vous</a> ou <a href="?action=inscription" class="bienv-link">inscrivez-vous</a> pour commencer</h4>
